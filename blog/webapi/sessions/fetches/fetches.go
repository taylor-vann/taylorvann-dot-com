...
func ValidateUser(params *requests.CreateClientSessionParams) (*responses.SafeRow, error) {
...
func GetGuestSession(params *requests.CreateGuestSessionParams) (*http.Cookie, error) {
	requestBodyBuffer, errRequestBodyBuffer := getRequestBodyBuffer(
		requests.RequestBody{
...
func RemoveSession(
	...
	requestBodyBuffer, errRequestBodyBuffer := getRequestBodyBuffer(
		requests.RequestBody{
			...
			Params: &requests.RemoveSessionRequestParams{
				Environment: environment,
